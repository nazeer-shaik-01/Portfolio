      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row md:space-x-12">
          <div className="flex-1 mb-8 md:mb-0">
            ...
            <p className="text-base md:text-lg">I&apos;m open to discussing software development projects, partnership opportunities, and career prospects. 
  Actively seeking roles where I can contribute to impactful projects and grow professionally. 
  Eager to build a strong professional network — let’s connect and explore how we can collaborate! 🚀</p>
            <div className='mb-4 mt-8'>
                <FaEnvelope className='inline-block text-green-400 mr-2' />
                <a href="mailto:nazeershaik1312@gmail.com" className='hover:underline text-green-400'>
                nazeershaik1312@gmail.com
                </a>
            </div>
            <div className='mb-4'>
                <FaPhone className='inline-block text-green-400 mr-2' />
                <span>+91 8179513686</span>
            </div>
            <div className='mb-4'>
