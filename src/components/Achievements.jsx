...
const achievements = [
  ...
  {
    title: 'LeetCode, GFG, Coding Ninjas',
    description: 'Masterfully solved 500+ problems, showcasing adept problem-solving skills.',
    url: 'https://leetcode.com/u/nazeershaik049/', // LeetCode profile URL
    additionalLinks: [
      { name: 'LeetCode', url: 'https://leetcode.com/u/nazeershaik049/' },
      { name: 'GeeksforGeeks', url: 'https://www.geeksforgeeks.org/user/shaiknazeerbaba/' }
    ],
    icon: <FaStar className="text-blue-500 text-4xl" /> // Example icon
  },
  {
    title: 'Leedcode',
    description: 'Awarded to the top 4.2% of LeetCoders for solving problems 100+ days in 2024.',
    url: 'https://leetcode.com/medal/?showImg=0&id=4106607&isLevel=false', // Replace with actual URL
